...
def CREDITS():
    ...
    print("Inspiré par Théophile, Romain, Tristan, Guillaume")
...
def combat(Perso,ennemi):
    ...
    while fin_combat=="":
        ...
        while nb_action>0:
            ...
            if action=="BOIRE UNE POTION" :
                ...
                print("Il reste",ennemi.pv,"PV","à",ennemi.type)
                nb_action=0
        ...
        if ennemi.pv>0:
            ...
            print("Il vous reste",Perso.pv,"PV")
        else :
            fin_combat="Victoire"
    ...
    if fin_combat=="Fuite":
        print("Vous avez réussi à fuir.")
    elif fin_combat=="Victoire":
        print("Vous avez vaincu le",ennemi.type)
    elif fin_combat=="Mort":
