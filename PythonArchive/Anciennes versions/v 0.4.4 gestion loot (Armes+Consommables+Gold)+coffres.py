...
class Personnage :
    def __init__ (self,nom,pv,inventaire,degats=2,protection=0,arme1="none",arme2="none",casque="chapeau de paille",plastron="chemise",jambières="pantalon",bottes="Souliers en cuir",argent=0,arme1_degats=0,arme1_protection=0,arme2_degats=0,arme2_protection=0,kill_Bandits=0,kill_Gobelins=0,kill_Trolls=0,kill_Dragons=0):
        self.name=nom
        self.pv=pv
...
Bandit=Ennemi("Bandit Guillaume",5,2,[Bouclier,"Rien",Arc,"Rien",Epée_une_main,Potion_lv1,Potion_lv1,Potion_lv2,Potion_lv2,Potion_lv3,"Rien",Arc,Epée_une_main],2,5)
