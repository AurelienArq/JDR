...
class Personnage :
    def __init__ (self,nom,pv,inventaire,pv_max=100,niv=1,exp=0,degats=2,protection=0,arme1="none",arme2="none",casque="chapeau de paille",plastron="chemise",jambières="pantalon",bottes="Souliers en cuir",argent=0,arme1_degats=0,arme1_protection=0,arme2_degats=0,arme2_protection=0,casque_protection=0,plastron_protection=0,jambières_protection=0,bottes_protection=0,kill_Chevres=0,kill_Crocodiles=0,kill_Bandits=0,kill_Gobelins=0,kill_Trolls=0,kill_Dragons=0,Etat="Vivant"):
        self.name=nom
        self.Etat=Etat
        self.pv=pv
        self.pv_max=pv_max
