...
def loot(ennemi):
    ...
    if ennemi.loot!=[]:
        equip_laché=ennemi.loot[randint(0,len(ennemi.loot))]
        if equip_laché=="Rien":
...
Bandit=Ennemi("Bandit Guillaume",5,2,["Rien","Rien",Potion_lv1,Potion_lv1,Potion_lv1,Potion_lv2,Potion_lv2,Potion_lv3],2,5)
Crocodile=Ennemi("Crocodile",5,4,["Rien",Viande,Viande])
Gobelin=Ennemi("Gobelin",10,2,[],5,10)
Troll=Ennemi("Troll",50,10,[],10,15)
Dragon=Ennemi("Dragon",200,50,[],50,200)
Event=Evenement()
