...
if sauv=="OUI":
    ...
    for i in range(0,len(clé)) :
        if clé[i].isnumeric()==True:
            clé[i]=int(clé[i])
    print(clé)
    clé_Perso=[clé[i] for i in range(0,31)]
    clé_Chevre=[clé[i] for i in range(31,38)]
    clé_Crocodile=[clé[i] for i in range(38,45)]
    clé_Bandit=[clé[i] for i in range(45,52)]
    clé_Gobelin=[clé[i] for i in range(52,59)]
    clé_Troll=[clé[i] for i in range(59,66)]
    clé_Dragon=[clé[i] for i in range(66,73)]
    clé_Arme_et_Armure=[clé[i] for i in range(73,len(clé))]
    print(clé_Chevre)
    print(clé_Crocodile)
    print(clé_Bandit)
    print(clé_Gobelin)
