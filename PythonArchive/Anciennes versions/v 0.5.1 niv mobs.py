...
class Personnage :
    def __init__ (self,nom,pv,inventaire,degats=2,protection=0,arme1="none",arme2="none",casque="chapeau de paille",plastron="chemise",jambières="pantalon",bottes="Souliers en cuir",argent=0,arme1_degats=0,arme1_protection=0,arme2_degats=0,arme2_protection=0,casque_protection=0,plastron_protection=0,jambières_protection=0,bottes_protection=0,kill_Chevres=0,kill_Crocodiles=0,kill_Bandits=0,kill_Gobelins=0,kill_Trolls=0,kill_Dragons=0):
        self.name=nom
        self.pv=pv
...
class Ennemi :
    def __init__(self,type,pv,degats,loot,gold_min=0,gold_max=0,niv=1):
        self.type=type
        self.pv=pv
        self.degats=degats
...
def montée_lv_mob(ennemi):
    ...
    print("Attention",ennemi.type,"est maintenant niv",ennemi.lv," et ses dégats ont augmenté à",ennemi.degats)
...
def CREDITS():
    ...
    print("Avec le soutien de Théophile, Romain, Tristan, Guillaume, Alexandre, Thomas, Antoine, M.Koroloff")
...
Gobelin=Ennemi("Gobelin",10,2,[Epée_une_main,Dague,"Rien",Dague,Dague,"Rien",Dague,Epée_une_main,Dague,"Rien",Dague,Dague,"Rien",Dague,Epée_une_main,Dague,"Rien",Dague,Dague,"Rien",Dague,Casque],2,5)
Bandit=Ennemi("Bandit Guillaume",5,2,["Rien",Arc,"Rien",Epée_une_main,Potion_lv1,Potion_lv1,Potion_lv2,Potion_lv2,Potion_lv3,"Rien",Arc,Epée_une_main,"Rien",Arc,"Rien",Epée_une_main,Potion_lv1,Potion_lv1,Potion_lv2,Potion_lv2,Potion_lv3,"Rien",Arc,Epée_une_main,Bottes,Jambières],2,5)
Crocodile=Ennemi("Crocodile",5,4,["Rien",Viande,Viande,Viande])
Troll=Ennemi("Troll",50,10,[Epée_deux_mains,Epée_deux_mains,Epée_deux_mains,Epée_une_main,Plastron,Casque,"Rien"],10,15)
Dragon=Ennemi("Dragon",200,50,[Epée_une_main,Epée_deux_mains,Bouclier,Plastron],50,200)
Event=Evenement()
