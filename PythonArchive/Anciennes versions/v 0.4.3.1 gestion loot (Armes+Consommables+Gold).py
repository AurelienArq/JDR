...
#création des armes
Epée_une_main=Arme("Epée une main",1,10,0,1)
Epée_deux_mains=Arme("Epée deux mains",1,20,0,3)
Arc=Arme("Arc",1,30,0,3)
Bouclier=Arme("Bouclier",1,0,15,2)
Dague=Arme("Dague",1,5,0,1)
...
Bandit=Ennemi("Bandit Guillaume",5,2,["Rien",Arc,"Rien",Epée_une_main,Potion_lv1,Potion_lv1,Potion_lv2,Potion_lv2,Potion_lv3],2,5)
Crocodile=Ennemi("Crocodile",5,4,["Rien",Viande,Viande,Viande])
Gobelin=Ennemi("Gobelin",10,2,[Epée_une_main,Dague,"Rien",Dague],5,10)
Troll=Ennemi("Troll",50,10,[Epée_deux_mains,Epée_deux_mains,Epée_deux_mains,Epée_une_main,"Rien"],10,15)
Dragon=Ennemi("Dragon",200,50,[Epée_une_main,Epée_deux_mains],50,200)
Event=Evenement()
