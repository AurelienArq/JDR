...
class Personnage :
    def __init__ (self,nom,pv,inventaire,pv_max=100,niv=1,exp=0,degats=2,protection=0,arme1="none",arme2="none",casque="chapeau de paille",plastron="chemise",jambières="pantalon",bottes="Souliers en cuir",argent=0,arme1_degats=0,arme1_protection=0,arme2_degats=0,arme2_protection=0,casque_protection=0,plastron_protection=0,jambières_protection=0,bottes_protection=0,kill_Chevres=0,kill_Crocodiles=0,kill_Bandits=0,kill_Gobelins=0,kill_Trolls=0,kill_Dragons=0,Etat="Debut"):
        ...
        self.kill_Dragon=kill_Dragons+15
...
def Histoire_intro():
    ...
    print("Alors que vous contemplez cette fourmilière en ébullition depuis la fenêtre de votre chambre, une main ferme sur votre épaule vous rappel à la réalité. Vous vous retournez et apercevez votre plus fidèle compagnon, Conrad.",end=" ")
    ...
    print("Une fois arrivé sur place, vous apperecevez les gardes qui tirent en direction d'une forme gigantesque dans le ciel. À mesure que vos yeux s'habituent à la lumière aveuglante du Soleil, vous vous appercevez que cette forme est celle d'un dragon et pas n'importe lequel : Balarion, le Seigneur des Dragons.",end=" ")
    print("En obersvant ses griffes, vous comprenez immédiatement la situation : il a kidnappé le Roi. À peine avez vous eu le temps de le réaliser que Balarion s'envole déjà vers la Montagne pour rejoindre son antre. ")
    print("Quelques heures seulement après, à la suite d'une réunion du Conseil, se dernier s'approche de l'assistance encore sous le choc :'Afin de maintenir la stabilité du royaume, le Prince Leon assumera les fonctions. Quand à notre bien-aimé Souverain, nous avons décidé d'envoyer les nouveaux chevaliers",end=" ")
...
Chevre=Ennemi("Chèvre",5,2,[Viande,"Rien","Rien","Rien","Rien"],5)
Gobelin=Ennemi("Gobelin",10,2,["Rien","Rien","Rien","Rien","Rien","Rien",Epée_une_main,Epée_une_main,Epée_une_main,Dague,Dague,Dague,Dague,Dague,Dague,Dague,Dague,Dague,Dague,Dague,Dague,Casque],30,2,5)
Bandit=Ennemi("Bandit Guillaume",5,2,["Rien","Rien","Rien","Rien","Rien","Rien",Arc,Arc,Arc,Arc,Potion_lv1,Potion_lv1,Potion_lv1,Potion_lv1,Potion_lv2,Epée_une_main,Epée_une_main,Epée_une_main,Epée_une_main,Bottes,Jambières],15,2,5)
Crocodile=Ennemi("Crocodile",5,4,["Rien",Viande,Viande,Viande],20)
Troll=Ennemi("Troll",50,10,[Epée_deux_mains,Epée_deux_mains,Epée_deux_mains,Epée_une_main,Plastron,Casque,"Rien"],50,10,15)
