...
Gobelin=Ennemi("Gobelin",10,2,["Rien","Rien","Rien","Rien","Rien","Rien",Epée_une_main,Epée_une_main,Epée_une_main,Dague,Dague,Dague,Dague,Dague,Dague,Dague,Dague,Dague,Dague,Dague,Dague,Casque],2,5)
Bandit=Ennemi("Bandit Guillaume",5,2,["Rien","Rien","Rien","Rien","Rien","Rien",Arc,Arc,Arc,Arc,Potion_lv1,Potion_lv1,Potion_lv1,Potion_lv1,Potion_lv2,Epée_une_main,Epée_une_main,Epée_une_main,Epée_une_main,Bottes,Jambières],2,5)
