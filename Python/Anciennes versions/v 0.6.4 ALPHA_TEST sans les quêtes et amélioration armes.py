...
def Histoire_intro():
    ...
    print("Quelques heures seulement après, à la suite d'une réunion du Conseil, son représentant s'approche de l'assistance encore sous le choc :'Afin de maintenir la stabilité du royaume, le Prince Leon assumera les fonctions. Quand à notre bien-aimé Souverain, nous avons décidé d'envoyer les nouveaux chevaliers",end=" ")
