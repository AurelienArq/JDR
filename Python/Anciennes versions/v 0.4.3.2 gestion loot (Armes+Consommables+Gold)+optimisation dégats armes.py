...
class Personnage :
    def __init__ (self,nom,pv,inventaire,degats=2,protection=0,arme1="none",arme2="none",casque="chapeau de paille",plastron="chemise",jambières="pantalon",bottes="Souliers en cuir",argent=0,arme1_degats=0,arme1_protection=0,arme2_degats=0,arme2_protection=0):
        self.name=nom
        self.pv=pv
        ...
        if Perso.arme1=="none" and Perso.arme2=="none":
            ...
            while reponse=="False":
                ...
                if choix=="OUI":
                    ...
                    if Perso.arme2!="none":
                        Perso.arme2.lv=1
                        Perso.degats=Perso.degats-Perso.arme2.degats
                        Perso.protection=Perso.protection-Perso.arme2.protection
                    Perso.degats=Perso.degats+arme.degats
                    Perso.protection=Perso.protection+arme.protection
                    Perso.arme1_degats=arme.degats
                    Perso.arme1_protection=arme.protection
...
Lieu=["FORET (difficulté Debutant)","DONJON (difficulté Myenne)","FORET (difficulté Debutant)","VILLE","MARAIS (difficulté Facile)","FORET (difficulté Debutant)","MARAIS (difficulté Facile)","AUBERGE","FORET (difficulté Debutant)","FORET (difficulté Debutant)","MARAIS (difficulté Facile)","MONTAGNE (difficulté Maximale)"]
Perso=Personnage(input("Quel est le pseudo de ton personnage ?"),100,[])

Chevre=Ennemi("Chèvre",5,2,[Viande,"Rien","Rien","Rien","Rien"])
Gobelin=Ennemi("Gobelin",10,2,[Bouclier,Epée_une_main,Dague,"Rien",Dague,Dague,"Rien",Dague],2,5)
Bandit=Ennemi("Bandit Guillaume",5,2,[Bouclier,"Rien",Arc,"Rien",Epée_une_main,Potion_lv1,Potion_lv1,Potion_lv2,Potion_lv2,Potion_lv3],2,5)
