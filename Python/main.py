...
if sauv=="OUI":
    ...
    Nain=Ennemi(clé_Nain[0],clé_Nain[1],clé_Nain[2],[Marteau,Marteau,Hache,Hache],clé_Nain[3],clé_Nain[4],clé_Nain[5],clé_Nain[6])
    ...
    Bandit=Ennemi("Bandit",10,2,["Rien","Rien","Rien","Rien","Rien","Rien","Rien","Rien","Rien","Rien","Rien","Rien","Rien","Rien","Rien","Rien",Arc,Arc,Arc,Arc,Potion_lv1,Potion_lv1,Potion_lv1,Potion_lv1,Potion_lv2,Epée_une_main,Epée_une_main,Epée_une_main,Epée_une_main,Bottes,Jambières],15,1,3)
